...
- **Artifacts:** the deployment of this solution depends on many artifacts that must be hosted in Azure Blobs, ideally in the image management storage account.
