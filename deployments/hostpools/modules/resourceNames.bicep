...
var availabilitySetNamePrefix = '${replace(replace(nameConv_HP_Resources, 'resourceType', resourceAbbreviations.availabilitySets), 'location', locations[locationControlPlane].abbreviation)}-'
